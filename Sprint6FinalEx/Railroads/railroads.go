...
сама по себе не простая, но когда я начинал финальные задачи меня впервые за все это смутное время поразил ковид, и теперь я понимаю о как уменьшении iq
...
сменить все int на uint с количеством определенным количеством бит
...
в текущую вершину. По первому списку я прохожусь чтобы просто расставить значения первого типа в матрице, по второму я прохожусь и смотрю, есть ли другое значение
в ячейке матрицы, куда я хочу вставить текущее значение. Если есть, и оно не равно значению текущего листа, то возвращаю false и прерываю рекурсию (так себе
